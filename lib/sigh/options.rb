      ...
      @@options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :app_identifier,
         ...
         FastlaneCore::ConfigItem.new(key: :signing_identity,
                                     short_option: "-s",
                                     env_name: "SIGH_SIGNING_IDENTITY",
                                     description: "The identity to use to sign your app",
                                     default_value: CredentialsManager::AppfileConfig.try_fetch_value(:signing_identity)),
